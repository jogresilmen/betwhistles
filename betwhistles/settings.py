"""
Django settings for betwhistles project.
...
ENVIROMENT = environ.Env()
environ.Env.read_env(os.path.join(BASE_DIR, '.env'))
# Quick-start development settings - unsuitable for production
# See https://docs.djangoproject.com/en/4.1/howto/deployment/checklist/

# SECURITY WARNING: keep the secret key used in production secret!
# SECRET_KEY = 'django-insecure-$jv0+lloyr$1eygk-5zf^*$a2=9g+kt=5@v++o5_4yn%fz53@h'
SECRET_KEY = ENVIROMENT("SECRET_KEY")

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = ENVIROMENT.bool('DEBUG', default= False)

ALLOWED_HOSTS = tuple(ENVIROMENT.list('ALLOWED_HOSTS',default=[]))#['52.23.189.119']
...
WSGI_APPLICATION = 'betwhistles.wsgi.application'
